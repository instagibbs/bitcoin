...
public:
    CMainParams() {
        ...
        // Deployment of CHECKTEMPLATE
        consensus.vDeployments[Consensus::DEPLOYMENT_CHECKTEMPLATE].bit = 3;
        consensus.vDeployments[Consensus::DEPLOYMENT_CHECKTEMPLATE].nStartTime = Consensus::BIP9Deployment::NEVER_ACTIVE;
        consensus.vDeployments[Consensus::DEPLOYMENT_CHECKTEMPLATE].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
        consensus.vDeployments[Consensus::DEPLOYMENT_CHECKTEMPLATE].min_activation_height = 0;
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        // Deployment of CHECKTEMPLATE, tests activation
        consensus.vDeployments[Consensus::DEPLOYMENT_CHECKTEMPLATE].bit = 3;
        consensus.vDeployments[Consensus::DEPLOYMENT_CHECKTEMPLATE].nStartTime = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_CHECKTEMPLATE].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
        consensus.vDeployments[Consensus::DEPLOYMENT_CHECKTEMPLATE].min_activation_height = 0; // No activation delay
