...
public:
    explicit MiniMinerMempoolEntry(CAmount feei, CAmount feea, int64_t sizei, int64_t sizea, const CTransactionRef& tx_in):
        tx{tx_in},
        vsize_individual{sizei},
        vsize_with_ancestors{sizea},
        fee_individual{feei},
        fee_with_ancestors{feea}
    { }
...
class MiniMiner
{
    ...
    // sequence number.
    std::map<uint256, uint32_t> m_inclusion_order;
