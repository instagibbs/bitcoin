...
public:
     ...
     */
    Session(CTransactionRef tx, Clock::time_point scheduled_start, FastRandomContext& rng);
    ...
    /** The next moment OnTick() can change anything. */
    Clock::time_point NextDeadline() const { return m_deadline; }
