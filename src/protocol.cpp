...
const char* WCMPCTBLOCK = "wcmpctblock";
const char* GETWBLOCKTXN = "getwblocktxn";
const char* WBLOCKTXN = "wblocktxn";
} // namespace NetMsgType
...
const static std::vector<std::string> g_all_net_message_types{
    ...
    NetMsgType::WCMPCTBLOCK,
    NetMsgType::GETWBLOCKTXN,
    NetMsgType::WBLOCKTXN,
};
