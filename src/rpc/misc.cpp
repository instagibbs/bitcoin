...
UniValue validateaddress(const JSONRPCRequest& request)
{
    ...
    if (isValid)
    {
        ...
        CKeyID keyID;
        CScriptID scriptID;
        if (pwalletMain && (address.GetKeyID(keyID) || (address.GetScriptID(scriptID) && pwalletMain->GetWitnessKeyID(scriptID, keyID))) && pwalletMain->mapKeyMetadata.count(keyID) && !pwalletMain->mapKeyMetadata[keyID].hdKeypath.empty())
        {
