...
public:
    ...
    virtual bool CheckSchnorrSignature(Span<const unsigned char> sig, const VersionedXOnlyPubKey& ver_pubkey, SigVersion sigversion, ScriptExecutionData& execdata, ScriptError* serror = nullptr) const
    {
        return false;
    }
...
public:
    ...
    bool CheckSchnorrSignature(Span<const unsigned char> sig, const VersionedXOnlyPubKey& ver_pubkey, SigVersion sigversion, ScriptExecutionData& execdata, ScriptError* serror = nullptr) const override;
...
public:
    ...
    bool CheckSchnorrSignature(Span<const unsigned char> sig, const VersionedXOnlyPubKey& ver_pubkey, SigVersion sigversion, ScriptExecutionData& execdata, ScriptError* serror = nullptr) const override
    {
        return m_checker.CheckSchnorrSignature(sig, ver_pubkey, sigversion, execdata, serror);
    }
