...
BOOST_AUTO_TEST_CASE(abort_received_private_broadcast_keeps_other_connection_demand)
{
    ...
    const size_t per_tx{connman.m_private_broadcast.NumToOpen() - base}; // NUM_PRIVATE_BROADCAST_PER_TX
    BOOST_REQUIRE(per_tx > 0);
    ...
    BOOST_CHECK_EQUAL(connman.m_private_broadcast.NumToOpen(), base + per_tx);
