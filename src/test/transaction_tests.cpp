...
static std::map<std::string, unsigned int> mapFlagNames = {
    ...
    {std::string("DISCOURAGE_UPGRADABLE_CHECKTEMPLATE"), (unsigned int)SCRIPT_VERIFY_DISCOURAGE_UPGRADABLE_CHECKTEMPLATE},
    {std::string("CHECKTEMPLATE"), (unsigned int)SCRIPT_VERIFY_CHECKTEMPLATE},
};
