...
void CMainSignals::TransactionAddedToMempool(const CTransactionRef& tx, uint32_t mempool_sequence) {
...
void CMainSignals::TransactionRemovedFromMempool(const CTransactionRef& tx, MemPoolRemovalReason reason, uint32_t mempool_sequence) {
