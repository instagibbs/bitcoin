...
public:
    ...
    void TransactionAddedToMempool(const CTransactionRef&, uint32_t mempool_sequence);
    void TransactionRemovedFromMempool(const CTransactionRef&, MemPoolRemovalReason, uint32_t mempool_sequence);
