...
enum WalletFeature
{
    ...
    FEATURE_WATCHONLY_HD = 139901, // Watch only Hierarchical key derivation after BIP32 (HD Wallet)
...
private:
    ...
    void DeriveNewChildKey(CKeyMetadata& metadata, CKey& secret, CPubKey& pubkey, bool internal = false);
...
public:
    ...
    bool SetHDMasterKey(const CExtPubKey& extPubKey);
};
