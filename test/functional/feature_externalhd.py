...
class ExternalHDTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.assert_start_raises_init_error(0, ['-externalhd=eopipwd'],
        'Invalid ExtPubKey format')
        self.assert_start_raises_init_error(0, ['-externalhd=tprv8ZgxMBicQKsPetaLcEpdoJFv6tai1kEQZFizVYzPqe3NkngpHGBnZRP8hUVrrxgaXgckrr2V38HKMTzPMGG5cJq6RymQ1Bn8v9ACJgh9RvG'],
        'Invalid ExtPubKey format')
        self.assert_start_raises_init_error(0, ['-externalhd=xpubD6NzVbkrYhZ4YTNYPw3XmSoBRZWmfn8mRerv3SEaC8UFiz5geKgCJH42cp9KUzRcfQNSuCQgdM1grUH7FgWYahWKDST3E9NYJMBwMKooTaY'],
        'Invalid ExtPubKey format')
        ...
        self.assert_start_raises_init_error(0, ['-externalhd=tpubD6NzVbkrYhZ4YTNYPw3XmSoBRZWmfn8mRerv3SEaC8UFiz5geKgCJH42cp9KUzRcfQNSuCQgdM1grUH7FgWYahWKDST3E9NYJMBwMKooTaY'],
