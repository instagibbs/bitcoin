...
class BlockchainTest(BitcoinTestFramework):
    ...
    def check_signalling_deploymentinfo_result(self, gdi_result, height, blockhash):
        ...
        assert_equal(gdi_result, {
          "hash": blockhash,
          "height": height,
          "script_flags": ["ANYPREVOUT","CHECKLOCKTIMEVERIFY","CHECKSEQUENCEVERIFY","CHECKSIGFROMSTACK","DEFAULT_CHECK_TEMPLATE_VERIFY_HASH","DERSIG","NULLDUMMY","OP_CAT","P2SH","TAPROOT","WITNESS"],
          "deployments": {
